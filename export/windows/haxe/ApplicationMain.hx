...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Kolor Kingdom", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Kolor Kingdom", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "32";
		app.meta["company"] = "impostor";
		app.meta["file"] = "Kolor Kingdom";
		app.meta["name"] = "Kolor Kingdom";
